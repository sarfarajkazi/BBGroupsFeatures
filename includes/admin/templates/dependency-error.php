...
if ( ! in_array( BBGF_MAIN_PLUGIN, apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	?>
    <strong><?php echo BBGF_NAME; ?></strong> - <?php _e( 'plugin requires', 'BBGroups-Feature' ); ?>
...
if(function_exists('bp_is_active')){
	if ( ! bp_is_active( 'groups' ) ) {
		printf(
			__( '<strong>' . BBGF_NAME . ' </strong> - BuddyBoss Courseware dependency error: <a href="%1$s">%2$s has to be activated</a>!', 'BBGroups-Feature' ),
